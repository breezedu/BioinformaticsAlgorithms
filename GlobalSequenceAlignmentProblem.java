 ...
 * Use the BLOSUM62 scoring matrix and indel penalty ¦Ò = 5.
 * 
 * @_@ author Frog Du
 *
 * Sample Input:
...
public class GlobalSequenceAlignmentProblem {
	...
	public static void main(String[] args) throws IOException{
		...
		printUpLCS(backTractMatrix, SeqOne, backRow-1, backCol-1);
		
		printLeftLCS(backTractMatrix, SeqTwo, backRow-1, backCol-1);
	 ...
	 * @param Col
	 */
	private static void printLeftLCS(char[][] backTractMatrix, String seqTwo, int Row, int Col) {
		...
		if(backTractMatrix[Row][Col] == 'O'){
			printLeftLCS(backTractMatrix, seqTwo, Row-1, Col-1);
			System.out.print(seqTwo.charAt(Row-1));
			
		} else if(backTractMatrix[Row][Col] == 'L'){
			printLeftLCS(backTractMatrix, seqTwo, Row, Col-1);
			System.out.print("-");
			
		} else if(backTractMatrix[Row][Col] == 'U'){
			printLeftLCS(backTractMatrix, seqTwo, Row-1, Col);
	...
	private static void printUpLCS(char[][] backTractMatrix, String seqOne, int Row, int Col) {
		// TODO To printout the longest routine from source to sink;
		if(Row==0 && Col==0){
			System.out.println();
			return;
		...
		if(backTractMatrix[Row][Col] == 'O'){
			printUpLCS(backTractMatrix, seqOne, Row-1, Col-1);
			System.out.print(seqOne.charAt(Col-1));
			
		} else if(backTractMatrix[Row][Col] == 'L'){
			printUpLCS(backTractMatrix, seqOne, Row, Col-1);
			System.out.print(seqOne.charAt(Col-1));    // here, it is very important;
			
		} else if(backTractMatrix[Row][Col] == 'U'){
			printUpLCS(backTractMatrix, seqOne, Row-1, Col);
			System.out.print("-");
